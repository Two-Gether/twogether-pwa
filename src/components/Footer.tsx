...
export default function Footer() {
  ...
  if (!mounted) {
    return (
      <div className="fixed bottom-0 left-0 right-0 bg-white px-4 py-2" style={{ borderTop: '1px #EEEEEE solid', paddingBottom: 'calc(16px + env(safe-area-inset-bottom, 0px))' }}>
