...
const MapIcon: React.FC<MapIconProps> = ({ className = '', width = 24, height = 24 }) => {
  return (
    <svg 
      width={width} 
      height={height} 
